 ...
 */
@Autonomous(name="SkellyOpHybrid", group="Autonomous")
public class AutoSkellyOpHybrid extends LinearOpMode {
...
//                telemetry.addData("VuMark", "%s visible", vuMark);
                    ...
                    driveForward(2,1);
                    swing.setTargetPosition(4);//we want it to be exact but I'm unsure of which number to use- we should test to find it
